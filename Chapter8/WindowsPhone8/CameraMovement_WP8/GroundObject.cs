...
namespace CameraMovement_WP8
{
    class GroundObject : GameFramework.MatrixObjectBase
    {
        ...
        private void BuildVertices()
        {
            ...
            _vertices[i++].TextureCoordinate = new Vector2(20.0f, 0.0f);
            _vertices[i++].TextureCoordinate = new Vector2(0.0f, 20.0f);
            _vertices[i++].TextureCoordinate = new Vector2(20.0f, 0.0f);
            _vertices[i++].TextureCoordinate = new Vector2(20.0f, 20.0f);
            _vertices[i++].TextureCoordinate = new Vector2(0.0f, 20.0f);
            // Set the normals
