...
namespace Balloons_Win8
{
    ...
    public class BalloonsGame : GameHost
    {
        ...
        public BalloonsGame()
        {
            ...
            _graphics.SupportedOrientations = DisplayOrientation.LandscapeLeft | DisplayOrientation.LandscapeRight | DisplayOrientation.Portrait | DisplayOrientation.PortraitUpsideDown;
        }
