    ...
    public class Game1 : Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            for (int i = 25; i >= 0; i--)
            {
                ...
                // iteration number.
                _spriteBatch.DrawString(_fontMiramonte, textString, new Vector2(400, 400), textcolor, MathHelper.ToRadians(_angle * ((i + 5) * 0.1f)), textsize / 2, 1 + (i / 5.0f), SpriteEffects.None, 0);
            }
